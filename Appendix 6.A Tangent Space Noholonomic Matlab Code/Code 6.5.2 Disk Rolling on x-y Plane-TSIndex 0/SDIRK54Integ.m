function[v,vd,w,wd,Lam,jiter,RM,k1,k2,k3,k4,k5,RR,h,hopt]=...
    SDIRK54Integ(tnm,n,nRepar,tn,Vv,Vvd,Ww,Wwd,LLam,Uu,Kk1,Kk2,Kk3,...
    Kk4,Kk5,q0,qd0,V,U,W,X,B,H,h,hmax,utol,intol,Btol,Htol,par,J2,errcontr)
...
z=-Jac\R5;
delk5=[z(1);z(2);z(3);z(4);z(5);z(6);z(7);z(8)];
delLam=[z(9);z(10);z(11);z(12);z(13);z(14)];
k5=k5+delk5;
Lam=Lam+delLam;
y5=y5k+h*a*k5;
