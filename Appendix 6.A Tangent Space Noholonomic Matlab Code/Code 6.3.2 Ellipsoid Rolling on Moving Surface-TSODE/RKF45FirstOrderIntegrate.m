function [yn,ydn,RM,h,h2,err,k]=RKF45FirstOrderIntegrate(tnm,ynm,...
    ue,V,U,W,X,B,H,q0,qd0,h,h2,utol,Btol,Htol,par,L,Jpr,hmax)
[nq,nh,nd,nv,nu,nw,nx,m,g,b,F]=parPart(par);
%RKF45 Coefficients
...
[f,RM]=ODEfunct(tnm+c(5)*h,ynm+h*(a(5,1)*k1+a(5,2)*k2+a(5,3)*k3+...
    a(5,4)*k4),ue,V,U,W,X,B,H,q0,qd0,utol,Btol,Htol,par,L,Jpr);
k5=f;
[f,RM]=ODEfunct(tnm+c(6)*h,ynm+h*(a(6,1)*k1+a(6,2)*k2+a(6,3)*k3+...
    a(6,4)*k4+a(6,5)*k5),ue,V,U,W,X,B,H,q0,qd0,utol,Btol,Htol,par,L,Jpr);
k6=f;
...
[f,RM]=ODEfunct(tnm+h,yn,ue,V,U,W,X,B,H,q0,qd0,utol,Btol,Htol,par,L,Jpr);
ydn=f;
