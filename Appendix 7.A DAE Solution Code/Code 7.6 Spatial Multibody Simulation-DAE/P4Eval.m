...
[P4cyl111,P4cyl112,P4cyl122]=...
    bbP4dot2(i,j,ux2pr,s1pr,s2pr,tn,q,eta(m+1),par);
[P4cyl211,P4cyl212,P4cyl222]=...
    bbP4dot2(i,j,uy2pr,s1pr,s2pr,tn,q,eta(m+2),par);
...
[P4rev511,P4rev512,P4rev522]=...
    bbP4dot2(i,j,uz2pr,s1pr,s2pr,tn,q,eta(m+5),par);
...
[P4tran511,P4tran512,P4tran522]=...
    bbP4dot1(i,j,uy1pr,ux2pr,tn,q,eta(m+3),par);
...
[P4kd111,P4kd112,P4kd122]=bbP4dot1(i,j,uz1pr,uz2pr,tn,q,par);
...
[P4str111,P4str112,P4str122]=bbP4dot2(i,j,ux1pr,s1pr,s2pr,tn,q,par);
[P4str211,P4str212,P4str222]=bbP4dot2(i,j,uy1pr,s1pr,s2pr,tn,q,par);
...
[P4RS211,P4RS212,P4RS222]=bbP4dot2(i,j,uz2pr,s1pr,s2pr,tn,q,par);
