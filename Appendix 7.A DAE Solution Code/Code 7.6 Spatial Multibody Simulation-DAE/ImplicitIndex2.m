function [q,qd,qdd,Lam,R1n,Jiter,JCond,h,nch,Err]=...
...
P2qdd=P2Eval(tnm,qnm,qddnm,SJDT,par);
...
QA=QAEval(tn,q,qd,SMDT,STSDAT,par);
S=SEval(q,qd,SMDT,par); 
R=[(1/(1+alpha))*M*qdd+Phiq'*Lam-QA-S+R1pnm;(1/(delta*h))*Phiq*qd];
