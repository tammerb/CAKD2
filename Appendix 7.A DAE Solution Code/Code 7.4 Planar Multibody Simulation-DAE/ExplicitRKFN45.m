function [q,qd,qdd,ECond,Err,h,nch]=ExplicitRKFN45(n,tn,Q,Qd,h,hmax,par,...
...
qhat=qnm+h*qdnm+(h^2)*k*D1';
qdhat=qdnm+h*k*d1';

%Evaluate  error with sciq=Atol*(1+abs(q(i))), sciqd=Atol*(1+abs(qd(i)))...
%and p=5
qdiff=q-qhat;
qddiff=qd-qdhat;
