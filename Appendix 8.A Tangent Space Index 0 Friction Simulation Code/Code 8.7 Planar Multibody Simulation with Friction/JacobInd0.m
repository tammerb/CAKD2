function [Rvdd,Rvd,Rv,Rhs,q,qd,D]=JacobInd0(tn,v,vd,vdd,Lam,u,par,q0,V,U,B,...
...
qdd=D*vdd-U*B*Gam;
M=MEval(PMDT,par);
QA=QAEval(tn,q,qd,Lam,PMDT,PJDT,PTSDAT,PRSDAT,par);
[QAsq,QAsqd]=QAsqqdEval(tn,q,qd,Lam,PMDT,PJDT,PTSDAT,PRSDAT,par);
