...
[vdd,Lam,jodeiter,ECond]=FrODEfunct(n,tnm+h/2,vnm+(h/2)*vdnm+(h^2/8)*k1,...
    vdnm+(h/2)*k1,vdd,Lam,Uu,q0,V,U,B,PJDT,PMDT,PTSDAT,PRSDAT,par);
k2=vdd;
[vdd,Lam,jodeiter,ECond]=FrODEfunct(n,tnm+h/2,vnm+(h/2)*vdnm+(h^2/8)*k1,...
    vdnm+(h/2)*k2,vdd,Lam,Uu,q0,V,U,B,PJDT,PMDT,PTSDAT,PRSDAT,par);
k3=vdd;
[vdd,Lam,jodeiter,ECond]=FrODEfunct(n,tnm+h,vnm+h*vdnm+(h^2/2)*k3,...
    vdnm+h*k3,vdd,Lam,Uu,q0,V,U,B,PJDT,PMDT,PTSDAT,PRSDAT,par);
k4=vdd;
