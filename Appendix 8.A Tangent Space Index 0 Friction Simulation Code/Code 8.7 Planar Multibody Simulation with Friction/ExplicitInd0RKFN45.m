function [v,vd,vdd,Lam,ECond,Err,h,nch,jodeiter1]=...
...
vd=vdnm+h*k*b1';
[vdd,Lam,jodeiter,ECond]=FrODEfunct(n-1,tnm+h,v,vd,vdd,Lam,u,...
    q0,V,U,B,PJDT,PMDT,PTSDAT,PRSDAT,par);
