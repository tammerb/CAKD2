function[v1,v1d,v1dd,Lam1,jiter,R1n,h,JCond,Rnorm]=IntegTanSpTrap1(n,npar,...
    Vv1,Vv1d,Vv1dd,LLam1,Uu1,q0,V1,U1,B1,par,mode)

[nq,nh1,nv1,nu1,nh2,nv2,nu2,g,m1,m2,m3,K1,K2,el,mud,mus,...
    utol,Btol,intol,h,q1b,q2b]=Partpar(par);
