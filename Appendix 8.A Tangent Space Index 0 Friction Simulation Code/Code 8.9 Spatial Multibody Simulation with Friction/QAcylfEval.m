function [fx1prk,fy1prk,fx2prk,fy2prk,f12kcylfr,tau12kcylfr]=...
    QAcylfEval(tn,q,qd,Lam,SMDT,SJDT,STSDAT,par)
%Calculate cylindrical joint contact force and friction force and torque
...
%Account for gravitational force in negative z direction, applied force F, 
%and applied torque npr on body i
i=1;
while i<=nb
mi=SMDT(1,i);
