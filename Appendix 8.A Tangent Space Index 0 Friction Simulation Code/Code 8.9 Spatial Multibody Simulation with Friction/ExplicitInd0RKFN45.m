function [v,vd,vdd,Lam,ECond,h,nch]=ExplicitInd0RKFN45(n,tn,Vv,Vvd,...
...
vd=vdnm+h*k*b1';
[vdd,Lam,jodeiter,ECond]=FrODEfunct(n,tnm+h,v,vd,k6,Lam,u,...
    q0,V,U,B,SJDT,SMDT,STSDAT,par);
