function [v,vd,vdd,Lam,jiter,R1n,h,JCond,Rnorm]=IntegTanSpTrap(t,...
...
[Rvdd,Rvd,Rv,Phiq]=JacobFull(t,v,vd,vdd,Lam,u,par,q0,V,U,B);
...
[R,B,h]=Resid(t,vdd,Lam,vnm,vdnm,vddnm,u,B,q0,V,U,par);
