function Phiq=PhiqEval(q,SJDT,par)
...
[Phiq1,Phiq2]=bbPhiqsph(i,j,s1pr,s2pr,q,par);
Phiq=Add(Phiq,Phiq1,m,7*(i-1));      
...
[Phiqcyl31,Phiqcyl32]=bbPhiqdot1(i,j,vz1pr,vx2pr,q,par);
[Phiqcyl41,Phiqcyl42]=bbPhiqdot1(i,j,vz1pr,vy2pr,q,par);
[Phiqtran51,Phiqtran52]=bbPhiqdot1(i,j,vy1pr,vx2pr,q,par);
...
[Phiqks1,Phiqks2]=bbPhiqsph(i,j,s1pr,s2pr,q,par);
[Phiqkd11,Phiqkd12]=bbPhiqdot1(i,j,vz1pr,vz2pr,q,par);
...
[Phiqstr11,Phiqstr12]=bbPhiqdot2(i,j,vx1pr,s1pr,s2pr,q,par);
[Phiqstr21,Phiqstr22]=bbPhiqdot2(i,j,vy1pr,s1pr,s2pr,q,par);
...
[PhiqRS11,PhiqRS12]=bbPhiqdist(i,j,s1pr,s2pr,d,q,par);
[PhiqRS21,PhiqRS22]=bbPhiqdot2(i,j,vz2pr,s1pr,s2pr,q,par);
...
[Phiq1,Phiq2]=bbPhiqdist(i,j,s1pr,s2pr,0,q,par);
Phiq=Add(Phiq,Phiq1,m,7*(i-1));
