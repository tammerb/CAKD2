function [Rvdd,Rvd,Rv,Rhs]=JacobODE(tn,v,vd,vdd,u,par,q0,V,U,B,SJDT,SMDT,STSDAT)
...
P21=P2Eval(tn,q,2*D*vdd-U*B*Gam,SJDT,par);
P22=P2Eval(tn,q,D*vd-U*B*Pst,SJDT,par);
M2=M2Eval(q,D*vdd-U*B*Gam,SMDT,par);

Rvdd=D'*M*D;
Rvd=-D'*(M*U*B*Gamsqd+QAsqd+Ssqd)*D;
Rv=D'*(-M*U*B*P21+P4+M2-M*U*B*Gamsq-QAsq-Ssq+...
    (M*U*B*Gamsqd+QAsqd+Ssqd)*U*B*(P22+Pstq))*D;

Rhs=D'*(M*U*B*P21-M2-P4+M*U*B*Gamsq+QAsq+Ssq)*qd+...
    D'*(M*U*B*Gamsqd+QAsqd+Ssqd)*qdd;
