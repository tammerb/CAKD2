...
%Nystrom integration step for v and vd 
[k1,ECond]=ODEfunct(tnm,vnm,vdnm,SMDT,STSDAT,SJDT,u,q0,V,U,B,par);
[k2,ECond]=ODEfunct(tnm+h/2,vnm+(h/2)*vdnm+(h^2/8)*k1,...
    vdnm+(h/2)*k1,SMDT,STSDAT,SJDT,u,q0,V,U,B,par);
[k3,ECond]=ODEfunct(tnm+h/2,vnm+(h/2)*vdnm+(h^2/8)*k1,...
    vdnm+(h/2)*k2,SMDT,STSDAT,SJDT,u,q0,V,U,B,par);
[k4,ECond]=ODEfunct(tnm+h,vnm+h*vdnm+(h^2/2)*k3,vdnm+h*k3,...
