function [v,vd,vdd,R1n,ImpSoliter,JCond,Jinv,Jinviter,h,nch]=...
...
%Jacobian Evaluation
[Rvdd,Rvd,Rv,Rhs]=JacobODE(tnm,vnm,vdnm,vddnm,unm,par,q0,V,U,B,...
...
R=ResidODE(tn,v,vd,vdd,u,B,q0,V,U,PJDT,PMDT,PTSDAT,PRSDAT,par);
