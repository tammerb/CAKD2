function[v,vd,vdd,Lam,jiter,R,k1,k2,k3,k4,k5,RR,h]=IntegTanSpSDIRK54FullNR...
...
R=Resid(v,vd,k1,Lam,u,par,q0,V,U,B,utol,Btol,h);
...
R=Resid(v,vd,k2,Lam,u,par,q0,V,U,B,utol,Btol,h);
...
R=Resid(v,vd,k3,Lam,u,par,q0,V,U,B,utol,Btol,h);
...
R=Resid(v,vd,k4,Lam,u,par,q0,V,U,B,utol,Btol,h);
...
R=Resid(v,vd,k5,Lam,u,par,q0,V,U,B,utol,Btol,h);
