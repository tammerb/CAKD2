...
[gsv,gsvd] =Agfsvvd(tn,vnm,vdnm,par,dat);
J=M+((h^2)/4)*(M2-gsv)-(h/16)*gsvd;
JCond=cond(J);
...
R1=AM(v,par,dat)*k1-Agf(tn,v,vd,par,dat);
...
R2=AM(v,par,dat)*k2-Agf(tn,v,vd,par,dat);
...
R3=AM(v,par,dat)*k3-Agf(tn,v,vd,par,dat);
...
R4=AM(v,par,dat)*k4-Agf(tn,v,vd,par,dat);
...
R5=AM(v,par,dat)*k5-Agf(tn,v,vd,par,dat);
